  ...
  return (
    <div className="bg-amber-50 text-gray-800">
      ...
      <section className="bg-amber-400 py-16 text-center text-gray-900">
        ...
        <button 
        className="px-10 py-3 bg-white text-amber-700 font-semibold rounded-full hover:bg-amber-100 transition"
